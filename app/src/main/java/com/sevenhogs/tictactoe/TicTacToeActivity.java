...
public class TicTacToeActivity extends Activity {
    ...
    {
        AlertDialog.Builder alertboxfinish = new AlertDialog.Builder(this);
        alertboxfinish.setMessage("Do want to Exit Game?");


        alertboxfinish.setTitle("TicTacToe");
        alertboxfinish.setIcon(R.drawable.ic_tictactoe);
        alertboxfinish.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
                Toast.makeText(getApplicationContext(), "TicTacToe game finished", Toast.LENGTH_SHORT).show();
                finish();
            }

        });
        alertboxfinish.setNegativeButton("No", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface arg0, int arg1) {
